...
#"Xu-AE-opt_adam-epo_100000-lr_0.025-date_24Mar2025-hour_10h50_Tr0D-2s_s2"
...
np.save(f'data-files/MSE_NN/MSE_train_val_NN_{clear_id_model}_{dataset_type}_s{my_seed}_epo{max_epo}_lr{learning_rate}_scaleManifold{scaleManifold}.npy', list_MSE_train_val)
np.save(f'data-files/MSE_NN/MSE_QoIs_val_NN_{clear_id_model}_{dataset_type}_s{my_seed}_epo{max_epo}_lr{learning_rate}_scaleManifold{scaleManifold}.npy', list_MSE_QoIs_val)

if(save_MSE_all_observations):
    np.save(f'data-files/MSE_NN/MSE_allObs_QoIs_val_NN_{clear_id_model}_{dataset_type}_s{my_seed}_epo{max_epo}_lr{learning_rate}_scaleManifold{scaleManifold}.npy', squared_errors.detach().cpu().numpy())
    np.save(f'data-files/MSE_NN/MSE_seeds_val_NN_{clear_id_model}_{dataset_type}_s{my_seed}_epo{max_epo}_lr{learning_rate}_scaleManifold{scaleManifold}.npy', validation_indices)